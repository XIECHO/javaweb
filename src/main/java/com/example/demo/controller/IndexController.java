...
import com.example.demo.service.ToutiaoService;
...
public class IndexController {
    ...
    public String index(HttpSession session){
        ...
        logger.info("Visit Index wode");
        return "Hello dengxi " + session.getAttribute("msg")
    ...
    public String requset(HttpServletRequest request,
        ...
        sb.append("getRequsetURI:" + request.getRequestURI() + "<br>");
